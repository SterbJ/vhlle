...
//     _d_taupi = -5. / 5.068 * etaS(e_bck, rho, T_bck) / (T_bck * T_bck) * dT * d_e; // fluctuation shear
     _taupi = 5. / 5.068 * 0.0000000012 / T_bck ; // background shear
     _d_taupi = -5. / 5.068 * 0.0000000012 / (T_bck * T_bck) * dT * d_e; // fluctuation shear
...
//     _d_tauPi = -6.0 / 5.068 * zetaS(e_bck, T_bck) / (T_bck * T_bck) * dT * d_e; // fluctuation bulk
     _tauPi = 6.0 / 5.068 * 0. / T0; // background bulk
     _d_tauPi = -6.0 / 5.068 * 0. / (T_bck * T_bck) * dT * d_e; // fluctuation bulk
 } else {
